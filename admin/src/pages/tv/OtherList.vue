<template>
  <div>
    ...
    <!-- 栏目Title -->
    <console-title title="其它影视列表" class="console-title-border">
      ...
      <div slot="right" style="width:auto;height:auto;position:absolute;top:10px;right:0px;">
        ...
        <router-link :to="{name:'TvCreate', params:{type:other.text }}"><Button type="primary">添加其它影视</Button></router-link>
      </div>
    </console-title>
  ...
  export default {
    ...
    methods: {
      loadData: function () {
        ...
        searchParams.tv_type = this.other.value
