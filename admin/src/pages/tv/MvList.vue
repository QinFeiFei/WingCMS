<template>
  <div>
    ...
    <!-- 栏目Title -->
    <console-title title="音乐MV列表" class="console-title-border">
      ...
      <div slot="right" style="width:auto;height:auto;position:absolute;top:10px;right:0px;">
        ...
        <router-link :to="{name:'TvCreate', params:{type:mv.text }}"><Button type="primary">添加音乐MV</Button></router-link>
      </div>
    </console-title>
  ...
  export default {
    ...
    methods: {
      loadData: function () {
        ...
        searchParams.tv_type = this.mv.value
