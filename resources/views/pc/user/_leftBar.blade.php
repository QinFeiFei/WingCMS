...
<div class="account_left">
    <ul class="account_nav">
        ...
        <li><a href="{{ route('pc::userBindPhone') }}" class="{{ $curBar=='pc::userBindPhone' ? 'curr_account':'' }}"><i class="icon-d png24"></i>绑定手机</a></li>
        ...
        <li><a href="{{ route('pc::userEditOauth') }}" class="{{ $curBar=='pc::userEditOauth' ? 'curr_account':'' }}"><i class="icon-g png24"></i>第三方授权</a></li>
    </ul>
</div>