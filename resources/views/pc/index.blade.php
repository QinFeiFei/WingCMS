    ...
    <div class="main">
        ...
        <div class="row clearfix">
            <div class="col_c">
                ...
                <div class="v_mod mt30">
                    ...
                    <div class="v_tb">
                        <div class="v_picConBox height612">
                            <ul class="v_picTxt pic180_240 pic180_210 clearfix">
                                @forelse($cartoon['puts'] as $k=>$value)
                                    <li>
                                        <div class="pic">
                                            <img src="{{ asset('storage/'.$value->tv_cover) }}" onerror="javascript:this.src='{{ asset('pc/images/v_defaultPic.png') }}';" />
                                            <a class="aPlayBtn" href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}"><i></i></a>
            ...
            <div class="col_d">
                <div class="v_mod mod-home-rank">
                    <div class="v_th_s">
                        <span class="sMark"><a href="">近期更新的动漫</a></span>
                    </div>
                    <div class="v_tb">
                        <div class="v_conBox">
                            <ul class="v_rank clearfix">
                                @forelse($cartoon['news'] as $k=>$value)
                                    <li>
                                        <i class="iNum {{ $k<3 ? 'iCurNum' : '' }}">{{ $k+1 }}</i>
                                        {{--<span class="sTips">8.3分</span>--}}
                                        <a href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}">{{ $value->tv_name }}</a>
        ...
        <div class="row clearfix">
            <div class="col_c">
                ...
                <div class="v_mod mt30">
                    ...
                    <div class="v_tb">
                        <div class="v_picConBox height612">
                            <ul class="v_picTxt pic180_240 pic180_210 clearfix">
                                @forelse($variety['puts'] as $k=>$value)
                                    <li>
                                        <div class="pic">
                                            <img src="{{ asset('storage/'.$value->tv_cover) }}" onerror="javascript:this.src='{{ asset('pc/images/v_defaultPic.png') }}';" />
                                            <a class="aPlayBtn" href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}"><i></i></a>
            ...
            <div class="col_d">
                <div class="v_mod mod-home-rank">
                    <div class="v_th_s">
                        <span class="sMark"><a href="">近期更新的综艺</a></span>
                    </div>
                    <div class="v_tb">
                        <div class="v_conBox">
                            <ul class="v_rank clearfix">
                                @forelse($variety['news'] as $k=>$value)
                                    <li>
                                        <i class="iNum {{ $k<3 ? 'iCurNum' : '' }}">{{ $k+1 }}</i>
                                        {{--<span class="sTips">8.3分</span>--}}
                                        <a href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}">{{ $value->tv_name }}</a>
        ...
        <div class="row clearfix">
            ...
            <div class="col_d">
                <div class="v_mod mod-home-rank">
                    <div class="v_th_s">
                        <span class="sMark"><a href="">近期更新的MV</a></span>
                    </div>
                    <div class="v_tb">
                        <div class="v_conBox">
                            <ul class="v_rank clearfix">
                                @forelse($mv['news'] as $k=>$value)
                                    <li>
                                        <i class="iNum {{ $k<3 ? 'iCurNum' : '' }}">{{ $k+1 }}</i>
                                        {{--<span class="sTips">8.3分</span>--}}
                                        <a href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}">{{ $value->tv_name }}</a>
        ...
        <div class="row clearfix">
            <div class="col_c">
                ...
                <div class="v_mod mt30">
                    <div class="v_th">
                        <span class="sMark"><i class="iMovieIcon"></i>其它热播</span>
                        <a href="{{ route('pc::tvList', ['type'=>'movie']) }}" class="aMore_left">更多&gt;</a>
                    </div>
                    <div class="v_tb">
                        <div class="v_picConBox height612">
                            <ul class="v_picTxt pic180_240 pic180_210 clearfix">
                                @forelse($other['puts'] as $k=>$value)
                                    <li>
                                        <div class="pic">
                                            <img src="{{ asset('storage/'.$value->tv_cover) }}" onerror="javascript:this.src='{{ asset('pc/images/v_defaultPic.png') }}';" />
                                            <a class="aPlayBtn" href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}"><i></i></a>
            ...
            <div class="col_d">
                <div class="v_mod mod-home-rank">
                    <div class="v_th_s">
                        <span class="sMark"><a href="">近期更新的其它影视</a></span>
                    </div>
                    <div class="v_tb">
                        <div class="v_conBox">
                            <ul class="v_rank clearfix">
                                @forelse($other['news'] as $k=>$value)
                                    <li>
                                        <i class="iNum {{ $k<3 ? 'iCurNum' : '' }}">{{ $k+1 }}</i>
                                        {{--<span class="sTips">8.3分</span>--}}
                                        <a href="{{ route('pc::tvDetail', ['type'=>'movie', 'tv_id'=>idEncode($value->tv_id)]) }}">{{ $value->tv_name }}</a>
